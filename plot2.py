...
df = pd.read_excel('data6_2.xlsx', sheet_name='Data')
...
fig.update_layout(title='Доля населения, пользующегося услугами санитарии', xaxis_title='Год', yaxis_title='Доля населения, %')
